...
- (NSString *)seatCollectionView:(SeatCollectionView *)collectionView seatNameforIndexPath:(NSIndexPath *)indexPath {
	...
	if(seat == NULL) {
		...
		//		return [NSString stringWithFormat:@"R = %d C = %d S = %@", seat.seat_Row, seat.seat_Column, seat.seat_Name];
		return @"";
	}
}
